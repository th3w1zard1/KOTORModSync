        ...
        private static void Main(string[] args)
        {
            try
            {
                ...
                while (! exit)
                {
                    ...
                    Console.WriteLine(
                        "4. (dev) generate mod directory trees from compressed files.");
                    ...
                    switch (input)
                    {
                        case "1":
                            ...
                            Console.WriteLine(
                                "VERY IMPORTANT: Do not extract rename any mod archives.");
                            Console.WriteLine(
                            ...
                            {
                                Console.WriteLine(
                                    "Please try again and choose your KOTOR installation dir.");
                                break;
                            }
                        ...
                        case "5":
                            ...
                            {
                                Console.WriteLine(
                                    "Please select your KOTOR2 installation directory first.");
                                break;
                            }
                        ...
                        case "6":
                            ...
                            if (File.Exists(filePath))
                            {
                                ...
                                foreach (Component mod in components)
                                {
                                    ...
                                    Console.WriteLine(
                                        $"Non-English Functionality: {mod.NonEnglishFunctionality}");
                                    Console.WriteLine(
                                        $"Installation Method: {mod.InstallationMethod}");
                                    Console.WriteLine(
                                        $"Installation Instructions: {mod.Directions}");
                                    Console.WriteLine();
                                }

                                Console.WriteLine(
                                    "Enter the output directory for parsed_reddit.toml file");

                                string outPath = Console.ReadLine();
                                FileHelper.OutputConfigFile(components, outPath + "\\parsed_reddit.toml");
                                Console.WriteLine(
                                    $"File saved as 'parsed_reddit.toml' in directory {outPath}");
                            }
